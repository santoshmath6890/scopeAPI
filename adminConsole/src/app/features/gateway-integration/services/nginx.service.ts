...
export class NginxService {
  private apiUrl = `${environment.gatewayApiUrl}/nginx`;
  ...
  getUpstreams(integrationId: string): Observable<any[]> {
    return this.http.get<any[]>(`${this.apiUrl}/integrations/${integrationId}/upstreams`);
  }
