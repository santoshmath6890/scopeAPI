...
export class TraefikService {
  private apiUrl = `${environment.gatewayApiUrl}/traefik`;
  ...
  getRouters(integrationId: string): Observable<any[]> {
    return this.http.get<any[]>(`${this.apiUrl}/integrations/${integrationId}/routers`);
  }
  ...
  getMiddlewares(integrationId: string): Observable<any[]> {
    return this.http.get<any[]>(`${this.apiUrl}/integrations/${integrationId}/middlewares`);
  }
} 